...
function render(stats){
    ...
    while(i < 20 && i+((page-1)*20)< series.length){
      ...
      var text = "";
      if(series[current_show].status == "completed" && current_show < series.length){
        text='<div class="movies">';
          ...
          if(series[current_show].poster_path == "N/A"){
            ...
            text = text+ `<button class="btn edit" id=${series[current_show].id} onclick="editList(${series[current_show].id});"><i class="fa fa-edit"></i></button>`;
